...
//
//        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("1001234Place").child(entryDate);
//        databaseReference.addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot snapshot) {
//                entryPlace.clear();
//                Log.d(TAG, "Firebase data change");
//                for (DataSnapshot day_snpsht: snapshot.getChildren()) {
//                   PlaceEntry data = day_snpsht.getValue(PlaceEntry.class);
//                    entryPlace.add(0, data);
